...
public class ConnectionUtil {
    ...
    public PreparedStatement getPreparedStatement(String sql) throws SQLException {
        return ConnectionUtil.getInstance().getConnection().prepareStatement(sql);
    }

    public PreparedStatement getPreparedStatementWithGeneratedKey(String sql, int autoGeneratedKeys) throws SQLException {
        return ConnectionUtil.getInstance().getConnection().prepareStatement(sql, autoGeneratedKeys);
    }
    ...
    public PreparedStatement getPreparedStatementWithResultSetType(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        return ConnectionUtil.getInstance().getConnection().prepareStatement(sql, resultSetType, resultSetConcurrency);
    }
}
